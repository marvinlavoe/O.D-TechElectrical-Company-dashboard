...
export function generateInvoicePDF(data, type = 'Invoice') {
  ...
  doc.text('123 Tech Avenue', 14, 28)
  doc.text('Accra, Ghana', 14, 33)
  doc.text('+233 55 555 5555', 14, 38)
  doc.text('billing@odtech.com', 14, 43)
...
export function generateReceiptPDF(data) {
  ...
  doc.setTextColor(150, 150, 150)
  doc.setFontSize(9)
  doc.text('Generated by O.D DASHBOARD', 14, 280)
  doc.text('Thank you for choosing O.D TECH ELECTRICAL ENGINEERING SOLUTIONS!', 196, 280, { align: 'right' })
