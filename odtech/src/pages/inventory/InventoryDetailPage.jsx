...
import {
  ArrowLeft, Package, Hash, AlertTriangle,
  MapPin, ShoppingCart, Tag, Edit2, TrendingDown, TrendingUp
} from 'lucide-react'
  ...
  return (
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="bg-surface-card border border-surface-border rounded-xl p-6">
        ...
        {/* ─── Quick Stats ─── */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6 pt-5 border-t border-surface-border">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 align-top">
        ...
        {/* ─── Right col: Stock Movement History ─── */}
