...
export default function SettingsPage() {
  ...
  const handleSaveSystem = async () => {
    ...
    try {
      ...
      // Optionally also save to Supabase if you have a preferences table
      const { error } = await supabase
        .from("profiles")
        .update({
      ...
      console.error("System preferences save error:", err);
      toast.error(err.message || "Failed to save preferences");
    } finally {
      setLoading(false);
    }
        ...
        <div className="p-6 space-y-6">
            ...
            <>
              ...
              <div className="space-y-4 max-w-sm">
                <Input
                  ...
                  onChange={(e) =>
                    handleSecurityChange("current_password", e.target.value)
                  }
                />
                <Input
                  label="New Password"
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleSecurityChange("confirm_password", e.target.value)
                  }
                />
              </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-text-muted">
                        Your current device and browser
                      </p>
                    </div>
          ...
          {activeTab === "notifications" && (
            <>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-text-muted">
                        ...
                        {key === "customer_updates" &&
                          "Receive customer-related notifications"}
                        {key === "system_alerts" &&
              ...
              <div className="flex justify-end gap-3 pt-4">
                <Button variant="outline">Cancel</Button>
                <Button loading={loading} onClick={handleSaveNotifications}>
                  Save Preferences
                </Button>
              </div>
            </>
          ...
          {activeTab === "system" && (
            <>
              ...
              <div className="flex justify-end gap-3 pt-4">
                <Button variant="outline">Cancel</Button>
                <Button loading={loading} onClick={handleSaveSystem}>
                  Save Preferences
                </Button>
              </div>
            </>
